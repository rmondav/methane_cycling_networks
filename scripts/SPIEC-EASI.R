...
#MC_anO2_lake1_clean_otus=otu_table(MC_anO2_lake1_clean_psob, taxa_are_rows)
#MC_anO2_lake1_clean_taxa=tax_table(MC_anO2_lake1_clean_psob)
## save tables for later use
#write.csv(MC_anO2_lake1_clean_otus, file = "./MC_anO2_lake1_clean_otus.csv", row.names = FALSE)
#write.csv(MC_anO2_lake1_clean_taxa, file = "./MC_anO2_lake1_clean_taxa.csv", row.names = FALSE)
## run spiec.easi 
#MC_anO2_lake1_spieceasi <-spiec.easi(
#  MC_anO2_lake1_clean_otus, method='mb', lambda.min.ratio=0.01, 
#  nlambda=50, sel.criterion='stars', pulsar.select=TRUE, pulsar.params=paramargs)
#saveRDS(MC_anO2_lake1_spieceasi, "../results/MC_anO2_lake1_spieceasi.rds")
#MC_anO2_lake1_spieceasi <- readRDS("../results/MC_anO2_lake1_spieceasi.rds")


#MC_anO2_pond_clean_psob<-import_biom(
#  "./OTU_table_anO2_pond_cultures_2000_min10S.ovr29count.biom", 
#  parseFunction=parse_taxonomy_default)
...
#  parseFunction=parse_taxonomy_default)
#MC_anO2_lake2_clean_otus=otu_table(MC_anO2_lake2_clean_psob, taxa_are_rows)
#MC_anO2_lake2_clean_taxa=tax_table(MC_anO2_lake2_clean_psob)
#write.csv(MC_anO2_lake2_clean_otus, file = "./MC_anO2_lake2_clean_otus.csv", row.names = FALSE)
#write.csv(MC_anO2_lake2_clean_taxa, file = "./MC_anO2_lake2_clean_taxa.csv", row.names = FALSE)
#MC_anO2_lake2_spieceasi <-spiec.easi(
#  MC_anO2_lake2_clean_otus, method='mb', lambda.min.ratio=0.01, 
#  nlambda=50, sel.criterion='stars', pulsar.select=TRUE, pulsar.params=paramargs)
#saveRDS(MC_anO2_lake2_spieceasi, "../results/MC_anO2_lake2_spieceasi.rds")
...
TS_lake_2000_clean_taxa=tax_table(TS_lake_2000_clean_psob)
