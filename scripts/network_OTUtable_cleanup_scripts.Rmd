...
Klindworth, A., Pruesse, E., Schweer, T., Peplies, J., Quast, C., Horn, M. and Glöckner, F.O. (2012) Evaluation of general 16S ribosomal RNA gene PCR primers for classical and next-generation sequencing-based diversity studies. Opens external link in new windowNucleic Acids Res. 2013 Jan 1;41(1):e1. doi: 10.1093/nar/gks808
...
## subsample at 17 000 count TS lake cultures
single_rarefaction.py \
...
#and for lake TS
filter_otus_from_otu_table.py -i OTU_table_TS_lake_2000.biom -o OTU_table_TS_lake_2000_min18S.biom --min_samples 18
filter_otus_from_otu_table.py -i OTU_table_TS_lake_2000_min18S.biom -o OTU_table_TS_lake_2000_min18S.ovr38count.biom -n 38
biom summarize-table -i OTU_table_TS_lake_2000_min18S.ovr38count.biom >summary_TS_lake_2000_min18S.ovr38count.txt
biom summarize-table -i OTU_table_TS_lake_2000_min18S.ovr38count.biom --qualitative >summary_TS_lake_2000_min18S.ovr38count_qual.txt
...
# cultures have sparcity ~70% while lake sample 10 to 30% will try network at this level
...
filter_otus_from_otu_table.py -i OTU_table_TS_lake_cultures_2000.biom -o OTU_table_TS_lake_cultures_2000.ovr20count.biom -n 20
...
biom summarize-table -i OTU_table_TS_lake_cultures_2000.ovr20count.biom >summary_TS_lake_cultures_2000.ovr20count.txt
...
summarize_taxa.py -i OTU_table_TS_lake_17000.ovr170count.biom -o ../taxonomy_summary/TS_lake
summarize_taxa.py -i OTU_table_O2_lake_cultures_2000.ovr20count.biom -o ../taxonomy_summary/MC_O2_lake
...
summarize_taxa.py -i OTU_table_anO2_lake_cultures_2000.ovr20count.biom -o ../taxonomy_summary/MC_anO2_lake
